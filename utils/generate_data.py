...
if __name__ == '__main__':
    ...
    parser.add_argument("--videopath", type=str, default='/data/yqge/miao/DynamicNeRF/data/blackswan/blackswan.mp4',
                        help='video path')
    parser.add_argument("--data_dir", type=str, default='/data/yqge/miao/DynamicNeRF/data/',
