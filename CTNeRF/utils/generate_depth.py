...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_path", type=str, help='Dataset path', default='/data/yqge/miao/DynamicNeRF/data/blackswan')
    parser.add_argument('--model', help="restore midas checkpoint", default='../weights/midas_v21-f6b98070.pt')
